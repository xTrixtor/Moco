...
export interface ISavinggoalsClient {
     ...
     * @return Success
     */
    createSavingGoalEndpoint(savingGoalCDto: SavingGoalCDto): Promise<SavingGoalDto>;
     ...
     * @return Success
     */
    lazyLoadDepositRateEndpoint(savingGoalId: number, firstOfNexPage: number, hidePaidDeposits: boolean): Promise<LazyLoadDepositRateResponse>;

    /**
     * @return Success
     */
    payDepositRateEndpoint(payDepositRateDto: PayDepositRateDto): Promise<DepositRateDto>;
}
...
export class SavinggoalsClient extends BaseAPIClient implements ISavinggoalsClient {
    ...
    protected processCreateSavingGoalEndpoint(response: Response): Promise<SavingGoalDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    deleteSavingGoalEndpoint(savingGoalId: number): Promise<any> {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: Response) => this.processDeleteSavingGoalEndpoint(_response));
        });
    }
    ...
    lazyLoadDepositRateEndpoint(savingGoalId: number, firstOfNexPage: number, hidePaidDeposits: boolean): Promise<LazyLoadDepositRateResponse> {
        ...
        if (savingGoalId === undefined || savingGoalId === null)
            throw new Error("The parameter 'savingGoalId' must be defined and cannot be null.");
        else
            url_ += "SavingGoalId=" + encodeURIComponent("" + savingGoalId) + "&";
        if (firstOfNexPage === undefined || firstOfNexPage === null)
            throw new Error("The parameter 'firstOfNexPage' must be defined and cannot be null.");
        else
            url_ += "FirstOfNexPage=" + encodeURIComponent("" + firstOfNexPage) + "&";
        if (hidePaidDeposits === undefined || hidePaidDeposits === null)
            throw new Error("The parameter 'hidePaidDeposits' must be defined and cannot be null.");
        else
            url_ += "hidePaidDeposits=" + encodeURIComponent("" + hidePaidDeposits) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: Response) => this.processLazyLoadDepositRateEndpoint(_response));
        });
    }

    protected processLazyLoadDepositRateEndpoint(response: Response): Promise<LazyLoadDepositRateResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    payDepositRateEndpoint(payDepositRateDto: PayDepositRateDto): Promise<DepositRateDto> {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: Response) => this.processPayDepositRateEndpoint(_response));
        });
    }

    protected processPayDepositRateEndpoint(response: Response): Promise<DepositRateDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class LazyLoadDepositRateResponse implements ILazyLoadDepositRateResponse {
    depositRates?: DepositRateDto[];
    totalRates?: number;
